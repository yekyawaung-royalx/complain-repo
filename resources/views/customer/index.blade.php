                ...
                <form action="{{ url('customer-submit') }}" class="content-one customer-submit" id="oneSide"
                    ...
                    <div class="row wrapper">
                        <div class="col-lg-6 input_field">
                            ...
                            <input type="text" class="form-control mb-3" placeholder="Mg Mg" name="complainant_name"
                                id="complainant_name" required>
                        ...
                        <div class="col-lg-6 input_field">
                            ...
                            <input type="text" class="form-control mb-3" placeholder="YGNxxxxxxYGN" name="waybill_no"
                                id="waybill_no">
                        </div>
                        <div class="col-lg-6 input_field">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group p-1">
                                <button class="btn btn-danger" id="customer-submit" type="submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
                <form action="{{ url('employee-submit') }}" class="content-one employee-submit" id="oneSide"
                    ...
                    <div class="row wrapper">
                        ...
                        <div class="col-lg-4 re-hide">
                            ...
                            <select name="redir_message" id="redir_message" class="js-select2" style="width:100%">
                        ...
                        <div class="col-lg-3 re-hide">
                            <div class="form-group p-1">
                                <button class="btn btn-danger" type="submit" id="employee-submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
