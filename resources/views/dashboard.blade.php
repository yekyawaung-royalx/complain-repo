                        ...
                        <div class="card-body">
                            <div class="media static-widget">
                                <div class="media-body">
                                    <h6 class="font-roboto">Loss</h6>
                                    <h4 class="mb-0 counter">{{ $loss_complaints }}</h4>
                                </div>
                                <svg fill="#ea580c" height="39" width="45" version="1.1" id="Icons"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 32 32" xml:space="preserve" transform="matrix(-1,0,0,1,0,0)">
                                    <path
                                        d="M24,25.6V22c0-0.9-0.4-1.8-1.2-2.4l-3.7-2.8c-0.3-0.2-0.4-0.5-0.4-0.8s0.1-0.6,0.4-0.8l3.7-2.8c0.8-0.6,1.2-1.5,1.2-2.4V6.4
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        c0.6,0,1-0.4,1-1C26,27.5,25.2,26.3,24,25.6z M12.4,10.8c-0.4-0.2-0.5-0.7-0.4-1.1C12.2,9.3,12.6,9,13,9h6c0.4,0,0.8,0.3,1,0.7                                                                                                                                                                                  c0.1,0.4,0,0.9-0.4,1.1l-3,2C16.4,12.9,16.2,13,16,13s-0.4-0.1-0.6-0.2L12.4,10.8z M15.3,20.3c0.4-0.4,1-0.4,1.4,0l4.7,4.7H10.6                                                                                                                                                                          L15.3,20.3z">
                                    </path>
                                </svg>
                            </div>
                ...
                <div class="col-sm-6 col-xl-3 col-lg-6">
                    <div class="card o-hidden">
                        <div class="card-body">
                            <div class="media static-widget">
                                <div class="media-body">
                                    <h6 class="font-roboto">Delay Complain </h6>
                                    <h4 class="mb-0 counter">{{ $service_complaints }}</h4>
                                </div>
                ...
                <div class="col-sm-6 col-xl-3 col-lg-6">
                    <div class="card o-hidden">
                        <div class="card-body">
                            <div class="media static-widget">
                                <div class="media-body">
                                    <h6 class="font-roboto">Staff Complain</h6>
                                    <h4 class="mb-0 counter">{{ $service_complaints }}</h4>
                                </div>
